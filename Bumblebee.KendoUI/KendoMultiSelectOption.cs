...
namespace Bumblebee.KendoUI
{
    ...
    public class KendoMultiSelectOption : KendoDropDownListOption
    {
        ...
        public KendoMultiSelectOption(IBlock parent, By by, IWebElement tagList)
            : base(parent, by)
        {
            _tagList = tagList;
        }

        public KendoMultiSelectOption(IBlock parent, IWebElement element, IWebElement tagList)
            : base(parent, element)
        {
            _tagList = tagList;
        }
    ...
    {
        public KendoMultiSelectOption(IBlock parent, By by, IWebElement tagList)
            : base(parent, by, tagList)
        {
        }

        public KendoMultiSelectOption(IBlock parent, IWebElement element, IWebElement tagList)
            : base(parent, element, tagList)
        {
        }
