...
namespace Bumblebee.IntegrationTests.Shared.Pages.Implementation
{
	...
	{
		public CheckboxPage(Session session)
			: base(session)
		{
		}
		...
		public ICheckbox<CheckboxPage> CheckedCheckbox
		{
			get
			{
				return new Checkbox<CheckboxPage>(this, By.Id("CheckedCheckbox"));
			}
		}
		...
		public ICheckbox<CheckboxPage> UncheckedCheckbox
		{
			get
			{
				return new Checkbox<CheckboxPage>(this, By.Id("UncheckedCheckbox"));
			}
		}
	}
}
